...
public class SetFundingSourceConfirmedResponse{
	...
	public static SetFundingSourceConfirmedResponse createInstance(Map<String, String> map, String prefix, int index) {
		...
		if (responseEnvelope != null) {
			...
			setFundingSourceConfirmedResponse.setResponseEnvelope(responseEnvelope);
		}
		i = 0;
		while(true) {
			...
			if (error != null) {
				setFundingSourceConfirmedResponse = (setFundingSourceConfirmedResponse == null) ? new SetFundingSourceConfirmedResponse() : setFundingSourceConfirmedResponse;
				setFundingSourceConfirmedResponse.getError().add(error);
				i++;
			} else {
				break;
			}
